...
public class TraineeDaoImp implements TraineeDao {
	...
	public int insertAttendance(TraineeAttendance traineeAttendance) {
	  String INSERT_ATTENDANCE="INSERT INTO traineeattendance (firstName,emailId,attendance,attendanceDate)\r\n"
	  		+ "SELECT ?,?,?,?\r\n"
	  		+ "WHERE NOT EXISTS (\r\n"
	  		+ "    SELECT 1\r\n"
		...
		return jdbcTemplate.update(INSERT_ATTENDANCE,traineeAttendance.getTraineeName(),traineeAttendance.getTraineeEmailId(),
				traineeAttendance.getAttendance(),traineeAttendance.getAttendanceDate(),traineeAttendance.getTraineeEmailId(),traineeAttendance.getAttendanceDate());
	}
