...
public class AdminController {
	...
	public String handleRegisterAdminRequest(
			...
			@RequestParam("dateofbirth") String dateOfBirth, @RequestParam("gender") String gender,Model model
	...
	
	{
		...
		List<Trainee>traineeList=traineeDao.getViewOfTrainee();
		model.addAttribute("ViewOfTrainee",traineeList);
		...
		return "all_trainee_attendance";
	}

	@GetMapping("/openAllTraineeAttendanceReport")
