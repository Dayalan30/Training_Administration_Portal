...
function validateDate(endingDate) {
    ...
    parsedEndingDate.setHours(0, 0, 0, 0);

    if (parsedEndingDate.getTime() !== currentDate.getTime()) {
...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <a href="logout_trainee">Logout</a>
        </nav>
    </header>
    ...
    <main>
            ...
            <section class="card">
             ...
             <section class="card">
                ...
                <!-- Add your link and description here -->
                <a href="trainee_attendance?emailId=<%=traineeProfile.getEmailId()%>&firstName=<%=traineeProfile.getFirstName()%>">Attendance Page</a>
                <p>We Should put Attendance Daily.</p>
            </section>
